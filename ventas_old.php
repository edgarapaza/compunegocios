...
<script type="text/javascript">
	...
	function agregar(dato1, dato2, dato3){
	...
	function imprimir(){
		for (var i = 0; i < lista.length; i++) {
			alert(lista[i]);
			var salida = document.getElementById('listadatos');
			
			salida.innerHTML = '<p>'+ lista[i] +'</p>';
		}
	}
</script>
								...
								<table class="table table-bordered table-hover table-striped">
									...
									<tbody>
										...
										<tr>
											...
											<td><?php printf("S/. %.2f", $fila['precventa1'] ) ;?></td>
											<td><?php echo $fila['stocktotal'];?></td>
											<td><?php echo $fila['tienda'];?></td>
											<td>
												<a href="ventas_old.php?cod=<?php echo $fila['idproducto'];?>&producto=<?php echo $fila['descripcion'];?>&precio=<?php echo $fila['precventa1'];?>" type="button" class="btn btn-success" id="add"><span class="glyphicon glyphicon-plus"></span></a>

												  <?php echo "<button type='button' name='btnagregar' id='btnagregar' class='btn btn-primary'  onclick='agregar(". $fila['idproducto'] .");'>Agregar</button>";?>

						<button type="button" class="btn btn-default" name="btnver" id="btnver" onclick="imprimir();">Imprimir</button>
											</td>
										</tr>
										<?php
											}
