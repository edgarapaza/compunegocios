...
class PDF extends FPDF
{
    ...
    function FancyTable($header, $data)
    {
        ...
        $sql="SELECT p.codigo, p.fecEmision, f.familia, p.descripcion, p.cantidad FROM productos AS p, familia AS f WHERE f.IDfamilia = p.IDFamilia";
...
$header = array('Codigo','Fecha','Familia','Descripcion','Cantidad');
// Carga de datos
//AQUÍ VA TU VARIABLE
...
$pdf->Cell(190,10,'Reporte fechas por Familias y Descripcion',1,1,'C');
