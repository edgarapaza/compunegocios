...
class PDF extends FPDF
{
    ...
    function FancyTable($header, $data)
    {
        ...
        $sql="SELECT p.idproducto,f.codigo, p.descripcion, p.numserie, p.stocktotal FROM productos as p, familia as f WHERE f.IDfamilia = p.IDFamilia";
...
$header = array('Codigo','Familia','Producto','Num. Serie','Stock');
// Carga de datos
//AQUÍ VA TU VARIABLE
