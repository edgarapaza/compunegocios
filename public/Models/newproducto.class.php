...
class NewProducto
{
	...
	public function AddProducto($codproveedor,$producto, $numfactura,$fechaEmision,$numserie,$idfamilia,$idsubfamilia,
	...
	$pro_peso,$pro_tamaño,$pro_alto,$pro_largo,$pro_ancho,$pro_color,$pro_incluye,$obs,$imagen,$idalmacen,$IDPersonal)
	{
		...
		try {
			...
			$sql= "INSERT INTO productos (IDproveedor,producto, numFactura,fecEmision,numserie,IDFamilia,IDSubFam,IDmarca,modelo,tipoUnidad,tipArticulo,descripcion,preUnitario,marGanancia,precioVenta,cantidad,pro_peso,pro_tamaño,pro_alto,pro_largo,pro_ancho,pro_color,pro_incluye,pro_fecRegistro,IDPersonal,estadoActivo,obs,imagen,IDAlmacen) VALUES ('$codproveedor','$producto',$numfactura','$fechaEmision','$numserie','$idfamilia','$idsubfamilia','$idmarca','$modelo','$tipoUnidad','$tipoArticulo','$descripcion','$precioUnitario','$margenGanancia','$precioVenta','$cantidad','$pro_peso','$pro_tamaño','$pro_alto','$pro_largo','$pro_ancho','$pro_color','$pro_incluye','$pro_fecRegistro','$IDPersonal','$estadoActivo','$obs','$imagen','$idalmacen')";
